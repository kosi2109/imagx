...
class Movie extends Model
{
    ...
    public function syncTimes(string $movie_id, array | null $times) : bool
    {
        try {
            // if no times are post delete all times on movies
            if ($times == null) {
    ...
    public function syncgenres(string $movie_id, array | null $genres) : bool
    {
        try {
            if ($genres == null) {
